# watch-kahlerichtlinien.ps1
# Watcht NUR C:\kahle-vinci\knowledgebases\kahlerichtlinien rekursiv und sendet Webhook Events an n8n.

$RootPath   = "C:\kahle-vinci\knowledgebases\kahlerichtlinien"
$Webhook    = "http://localhost:5678/webhook/kb/kahlerichtlinien/sync"
$DebounceMs = 1200
