# watch-kahlekontext.ps1
# Watcht NUR C:\kahle-vinci\knowledgebases\kahleakontext rekursiv und sendet Webhook Events an n8n.

$RootPath   = "C:\kahle-vinci\knowledgebases\kahlekontext"
$Webhook    = "http://localhost:5678/webhook/kb/kahlekontext/sync"
$DebounceMs = 1200
