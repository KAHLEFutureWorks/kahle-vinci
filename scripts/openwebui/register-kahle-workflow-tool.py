...
KAHLE_WORKFLOW_SPECS = [
    {
        ...
        "description": (
            ...
            "und strukturierte Ergebnisse fuer Briefings, Praesentationsgliederungen oder direkt herunterladbare PDF/DOCX/MD-Dateien liefern. "
            ...
            "Nutze dieses Tool auch bevorzugt, wenn der Nutzer Recherche/Websuche UND Ausgabe als PDF/DOCX/Markdown in einer Anfrage verlangt."
        ),
        "parameters": {
            "type": "object",
            "properties": {
                ...
                "output_format": {
                    ...
                    "default": "auto",
                    "description": "Optional direkt eine neue Ergebnisdatei erzeugen. auto erkennt PDF/DOCX/Markdown-Wuensche aus dem Auftrag.",
                },
                "filename": {
                    "type": "string",
                    "default": "",
...
KAHLE_TASK_SPECS = [
    ...
    {
        "name": "kv_task_update",
        "description": "Aktualisiert eine bestehende persistente Aufgabe.",
        "parameters": {
            "type": "object",
            "properties": {
                "task_id": {"type": "string", "description": "ID der Aufgabe, z. B. task_ab12cd34ef56."},
    ...
    },
    {
        ...
        "description": "Markiert eine persistente Aufgabe als erledigt.",
        "parameters": {
            "type": "object",
